...
public class Aims {
    ...
    public static void main(String[] args) {
    	// CD
    	CompactDisc cd1 = new CompactDisc(3001, "The Beatles", "Music", 10.99f, 120, "Director", "The Beatles");
    	CompactDisc cd2 = new CompactDisc(3002, "Thriller", "Music", 9.99f, 110, "Quincy Jones", "Michael Jackson");
    	CompactDisc cd3 = new CompactDisc(3003, "Kind of Blue", "Jazz", 11.49f, 55, "Miles Davis", "Miles Davis");
    	CompactDisc cd4 = new CompactDisc(3004, "The Four Seasons", "Classical", 14.49f, 80, "Antonio Vivaldi", "Vivaldi");
    	Track track1 = new Track(180, "Let It Be");
    	Track track2 = new Track(240, "Hey Jude");
    	// DVD
    	DigitalVideoDisc dvd1 = new DigitalVideoDisc(2001, "Inception", "Sci-Fi", 14.99f, 148, "Christopher Nolan");
    	DigitalVideoDisc dvd2 = new DigitalVideoDisc(2002, "Mad Max: Fury Road", "Action", 19.99f, 120, "George Miller");
    	DigitalVideoDisc dvd3 = new DigitalVideoDisc(2003, "The Shawshank Redemption", "Drama", 13.49f, 142, "Frank Darabont");
    	DigitalVideoDisc dvd4 = new DigitalVideoDisc(2004, "The Grand Budapest Hotel", "Comedy", 17.99f, 99, "Wes Anderson");

    	// Book
    	Book book1 = new Book(1001, "The Alchemist", "Novel", 12.99f);
    	Book book2 = new Book(1002, "Harry Potter and the Sorcerer's Stone", "Fantasy", 15.99f);
    	Book book3 = new Book(1003, "The Girl with the Dragon Tattoo", "Mystery", 18.49f);
    ...
    public static void addMediaToStore() {
        ...
        Media media = new CompactDisc(1, title, "Music", 15.99f, 120, "Director", "Artist");
